...
SECRET_KEY = ')du2co=uzz86h5$iu=igupc9#x2rfmm913@fla=-w4t9golu%9'
...
ROOT_URLCONF = 'hivimx.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'hivimx.wsgi.application'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'front.pipeline.redirect_to_form',
    'front.pipeline.username',
    'social_auth.backends.pipeline.user.create_user',
    'social_auth.backends.pipeline.social.associate_user',
    'social_auth.backends.pipeline.social.load_extra_data',
    'social_auth.backends.pipeline.user.update_user_details',
    'social_auth.backends.pipeline.misc.save_status_to_session',
    'front.pipeline.redirect_to_form2',
    'front.pipeline.first_name',
)
